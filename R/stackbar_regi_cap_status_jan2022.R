finEx_reg_mag_nm_gcpt22 <- mselect(reg_mag_nm_gcpt22,Country=getItems(reg_mag_nm_gcpt22,1)[which(reg_mag_nm_gcpt22[,,"PreCon.PubG20.GW"]>0)])
finEx_glo_mag_nm_gcpt22 <- setItems(dimSums(finEx_reg_mag_nm_gcpt22,dim=1),dim=1,value="GLO")
  
q_finEx_by_host_reg <- as.quitte(mbind(finEx_reg_mag_nm_gcpt22,finEx_glo_mag_nm_gcpt22)) 
